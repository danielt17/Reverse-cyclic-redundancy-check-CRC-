...
def print_packets(packets: list[bytes]) -> None:
    '''
    Description:
...
def print_all_polynomial_representations(poly: int, crc_width: int) -> None:
    '''
    Description:
...
def print_estimated_polynomial_by_ranking_after_method(
    polys: Sequence[int], occurrence: Sequence[float], crc_width: int, enable_pre_text: bool = True
) -> None:
    '''
    Description:
...
def print_estimated_polynomials_and_xor_in(
    generator_polys: Sequence[int], useful_polys: Sequence[int], useful_xor_in: Sequence[Sequence[int]]
) -> None:
    '''
    Description:
...
def print_all_possible_xor_outs(combinations: Sequence[Combination]) -> None:
    '''
    Description:
    ...
    if len(combinations) == 0:
        ...
        for i in range(len(combinations)):
            print('Generator polynomial (taps): ' + hex(int(combinations[i][0])))
            print('Estimated XorIn (seed):      ' + hex(int(combinations[i][2])))
            print('Estimated XorOut (Mask/Final):     ' + hex(int(combinations[i][5])))
            print('\n')
        print('\n\n\n\n\n')

def print_estimated_full_estimated(combinations: Sequence[Combination]) -> None:
    '''
    Description:
    ...
    if len(combinations) == 0:
        ...
        for i in range(len(combinations)):
            print('\n')
            print('-----------------------------------------------')
            print('poly:        ' + hex(int(combinations[i][0])))
            print('width:       ' + str(int(combinations[i][1])))
            print('seed:        ' + hex(int(combinations[i][2])))
            print('ref_in:      ' + str(combinations[i][3]))
            print('ref_out:     ' + str(combinations[i][4]))
            print('xor_out:     ' + hex(int(combinations[i][5])))
            print('-----------------------------------------------')
        print('\n\n\n\n\n\n\n\n')
