...
2. one may formalize the CRC calculation in the following manner: https://latex.codecogs.com/svg.image?r&space;=&space;(&space;mx^n&plus;Ix^L&plus;F&space;)&space;mod&space;P
