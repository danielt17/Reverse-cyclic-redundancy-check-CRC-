...
2. one may formalize the CRC calculation in the following manner: <img src=https://latex.codecogs.com/png.image?\dpi{110}r&space;=&space;(&space;mx^n&plus;Ix^L&plus;F&space;)&space;mod&space;P>
